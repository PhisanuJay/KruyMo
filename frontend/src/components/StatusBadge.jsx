const STATUS_CONFIG = {
  ...
  ready_to_ship: { label: 'พร้อมส่งแมสฯ', color: '#00CEC9', bg: '#E0F7FA' },
  out_for_delivery: { label: 'แมสฯ กำลังนำส่ง', color: '#0984E3', bg: '#E3F2FD' },
  delivered: { label: 'ส่งถึงแล้ว', color: '#6C5CE7', bg: '#EDE7F6' },
  return_submitted: { label: 'ลูกค้าส่งคืนแล้ว', color: '#E17055', bg: '#FFF3E0' },
  ready_for_pickup: { label: 'พร้อมส่งแมสฯ', color: '#00CEC9', bg: '#E0F7FA' },
