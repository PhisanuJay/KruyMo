const STATUS_CONFIG = {
  ...
  preparing: { label: 'จัดเตรียมชุด', color: '#A29BFE', bg: '#F3E5F5' },
  ready_to_ship: { label: 'พร้อมจัดส่ง', color: '#00CEC9', bg: '#E0F7FA' },
  out_for_delivery: { label: 'กำลังจัดส่ง', color: '#0984E3', bg: '#E3F2FD' },
  delivered: { label: 'ส่งถึงแล้ว', color: '#6C5CE7', bg: '#EDE7F6' },
  return_submitted: { label: 'ลูกค้าส่งคืนแล้ว', color: '#E17055', bg: '#FFF3E0' },
  ready_for_pickup: { label: 'พร้อมจัดส่ง', color: '#00CEC9', bg: '#E0F7FA' },
  picked_up: { label: 'ส่งถึงแล้ว', color: '#6C5CE7', bg: '#EDE7F6' },
  returned: { label: 'รับคืนแล้ว', color: '#00B894', bg: '#E8F5E9' },
